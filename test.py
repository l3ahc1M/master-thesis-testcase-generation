...
import re
import time
from llm_connector import OpenAIAssistantConnector
...
def generate_test_cases_for_all_subfolders():
    connector = OpenAIAssistantConnector()
    root_input_dir = "system_documentation"
    root_output_dir = os.path.join("raw_testcases_assistant_api", "API")
    difficulties = ["Easy", "Medium", "Hard", "Very Hard"]
    test_cases_per_difficulty = 2
    i = 1
...
Generate {total_test_cases} test cases distributed evenly across the following difficulty levels: Easy, Medium, Hard, Very Hard.
"""
